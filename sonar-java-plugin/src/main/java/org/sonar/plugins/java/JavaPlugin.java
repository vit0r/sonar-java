...
public class JavaPlugin implements Plugin {
  ...
  public static final Version ANALYSIS_WARNINGS_MIN_SUPPORTED_SQ_VERSION = Version.create(7, 4);
  ...
  public void define(Context context) {
    ...
    if (isSupported(context.getRuntime())) {
   ...
   */
  private static boolean isSupported(SonarRuntime runtime) {
